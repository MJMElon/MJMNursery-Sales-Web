                ...
                <div className="modal-body" style={{ padding: '1.2rem', maxHeight: '75vh', overflowY: 'auto' }}>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: '1fr 220px', gap: '1rem', alignItems: 'start' }}>
                    ...
                    <div style={{ background: 'var(--bg)', borderRadius: '10px', padding: '.8rem' }}>
                      ...
                      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', alignItems: 'center', marginBottom: '.2rem' }}><span>Points redeem (pts)</span><input className="form-input" id="no-points-redeem" type="number" min="0" step="1" defaultValue="0" disabled onInput={(e) => { window.recalcNewOrderTotal(); }} style={{ width: '80px', textAlign: 'right', fontSize: '12px', padding: '4px 8px' }} /></div>
                      <div id="no-points-hint" style={{ fontSize: '10px', color: 'var(--ink4)', textAlign: 'right', marginBottom: '.3rem' }}>Link a customer to redeem points</div>
